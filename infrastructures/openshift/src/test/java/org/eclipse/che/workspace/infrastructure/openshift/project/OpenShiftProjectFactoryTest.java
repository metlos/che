...
public class OpenShiftProjectFactoryTest {
  ...
  @Test
  public void shouldReturnDefaultProjectOnlyWhenItExistsAndUserDefinedIsNotAllowed()
      throws Exception {
  ...
  @Test
  public void shouldReturnDefaultProjectOnlyWhenItDoesNotExistAndUserDefinedIsNotAllowed()
      throws Exception {
    throwExceptionOnTryToFindProjectByName(
  ...
  public void shouldReturnListOfExistingProjectsAlongWithDefaultIfUserDefinedIsAllowed()
    ...
    prepareListedProjects(
        Arrays.asList(
            createProject("my-for-ws", "Project for Workspaces", "some description", "Active"),
            createProject("default", "Che Default", "some description", "Active")));
  ...
  private void prepareListedProjects(List<Project> projects) throws Exception {
    when(clientFactory.createOC()).thenReturn(osClient);

    @SuppressWarnings("unchecked")
    NonNamespaceOperation<Project, ProjectList, DoneableProject, Resource<Project, DoneableProject>>
        projectOperation = mock(NonNamespaceOperation.class);
    when(osClient.projects()).thenReturn(projectOperation);
  ...
  private void throwExceptionOnTryToFindProjectByName(String name, KubernetesClientException e)
      throws Exception {
    when(clientFactory.createOC()).thenReturn(osClient);
